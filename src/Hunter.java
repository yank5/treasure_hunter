...
public class Hunter
{
    ...
    public void setTreasures(String x){
        treasures=x;
    }
    ...
    public void changeGold(int modifier)
    {
        ...
        {
            gold = 0;
            System.out.print("Game over, out of gold!");
            System.exit(0);
        }
    }
...
//            System.out.println("kit int: "+endOfItem); //debug
            String tmpItem = kit.substring(placeholder, endOfItem);
//            System.out.println("tmpItem in kit: "+tmpItem); //debug
